...
object PagerIndicatorDefaults {
     ...
     */
    val InactiveIndicatorColorAlpha
        @Composable
...
fun HorizontalPagerIndicator(
    ...
    width: Dp = PagerIndicatorDefaults.Size,
    height: Dp = PagerIndicatorDefaults.Size,
        ...
        Box(
            modifier = Modifier
                .offset {
                    ...
                    IntOffset(x = ((spacing + width) * scrollPosition).roundToPx(), y = 0)
                }
                .width(width)
                .height(height)
                .background(
